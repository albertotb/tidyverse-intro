...
- Gran cantidad de **paquetes** (9319 a 10 de octubre de 2019 -> 15103 a 12 de octubre de 2019):
...
```{r, echo=FALSE, message=TRUE, warning=TRUE, out.width="150%"}
...
- Documentación y manunales de R:
- R Reference Card: 
- Nivel Básico:
- Nivel avanzado: 
